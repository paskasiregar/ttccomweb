  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div className="p-8 md:p-20 bg-gradient-to-r from-black to-purple-700 text-white text-center rounded-xl">
        <h1 className="text-6xl md:text-6xl font-bold flex items-center justify-center mb-2">
      ...
      <div className="mt-4 grid gap-2 md:gap-4 sm:gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        <BaitCard
          icon={
