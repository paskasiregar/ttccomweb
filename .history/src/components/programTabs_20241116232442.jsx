...
import ClassType from "./classType"; // Import the cards component for online tab
  ...
  return (
    <div className="w-full">
      ...
      <div>
        {activeTab === "online" && (
          <div>
            {/* Render the cards for the online tab */}
            <ClassType />
          </div>
        )}
        {activeTab === "offline" && (
          <div>
            <p className="text-center text-gray-600">
              Konten untuk Kelas Offline sedang dalam pengembangan.
            </p>
          </div>
        )}
      </div>
